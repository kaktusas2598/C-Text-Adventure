local world = {
    objects = {
        ...
        openDoorToBackroom = {
            ...
            toggles_to = "closedDoorToBackroom",
            mirrors_to = "openDoorToCave",
            on_open = "isAlreadyOpen",
            on_close = "closeViaToggle",
        },
        closedDoorToBackroom = {
            ...
            toggles_to = "openDoorToBackroom",
            mirrors_to = "closedDoorToCave",
            on_open = "openViaToggle",
        ...
        openDoorToCave = {
            ...
            toggles_to = "closedDoorToCave",
            mirrors_to = "openDoorToBackroom",
            on_open = "isAlreadyOpen",
            on_close = "closeViaToggle",
        },
        closedDoorToCave = {
            ...
            contents = "You see",
            text_go = "The door is closed.",
            toggles_to = "openDoorToCave",
            mirrors_to = "closedDoorToBackroom",
            on_open = "openViaToggle",
            on_close = "isAlreadyClosed",
        },
        openBox = {
        ...
        lampOff = {
            ...
            tags = { "lamp" },
            location = "field",
            details = "The lamp is currently switched off.",
            contents = "You see",
